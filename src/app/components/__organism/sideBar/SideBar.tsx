...
const SideBar = () => {
  ...
  return (
    <section
      // style={{ width: minimize ? "300px" : "88px" }}
      className={`absolute z-10 bottom-0 left-0 max-h-[52px] w-full md:max-h-[74px] lg:left-0 lg:top-0  lg:min-h-full h-screen bg-[#201F24] lg:rounded-t-xl lg:rounded-tl-none lg:rounded-r-3xl order-last lg:order-none ${minimize ? "lg:w-[88px]" : "lg:w-[300px]"} transition-all duration-300 ease-in-out`}
    >
      <div className="text-[#B3B3B3] w-full px-10 lg:px-0 flex flex-row items-end justify-around lg:flex-col">
              ...
              >
                ...
                >
                  ...
                  <div className="w-full flex flex-col items-center justify-center pt-2 lg:justify-start lg:flex-row lg:items-center lg:gap-4 lg:py-4 lg:pl-[9.78%]">
                    ...
                    <p className={`hidden md:flex md:text-[12px] lg:text-base ${minimize && "lg:hidden"}`}>
                      {link.name ? link.name : ""}
                    </p>
                  </div>
                  <div className="w-full min-h-[5px] bg-[#277C78] lg:hidden"></div>
        ...
        <div className={`${minimize && "hidden "} w-full py-4 px-6 flex flex-col gap-4`}>
          <div className="w-full h-[1px] bg-[#B3B3B3]"></div>
          <div className="flex flex-col items-start gap-2 text-xs lg:pl-[9%]">
            <p className="">
              User:{" "}
            ...
            <div className="w-[20px] h-[20px] relative group flex items-center gap-2">
              <LogOut />
        ...
        >
          {/* <div className="flex flex-row items-center gap-4 py-4 pl-[11.81%] pt-[calc(100vh-432px)]"> */}
          <div className="flex flex-row items-center gap-4 py-4 pl-[11.81%] pt-[calc(100vh-561px)]">
            <MinimizeMenu />
