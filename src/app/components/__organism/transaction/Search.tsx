...
const Search = ({ handleSearchChange, isRecurringBills }: SearchPropsType) => {
  return (
    ...
    <div className={`${isRecurringBills ? "min-w-[259px] md:min-w-[320px]" : "w-[70.95%]"} relative border border-[#98908B] text-[#98908B] pl-[20px] md:pl-[10px] lg:pl-[20px] py-3 md:w-[22.75%] lg:w-[30.12%] overflow-hidden rounded-md`}>
      <input
        type="text"
