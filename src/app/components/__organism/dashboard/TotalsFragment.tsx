...
//     const Income = allData.reduce((acc, entry) => {
//       if (entry.amount > 0) {
//         acc += entry.amount;
//       }
//       return acc;
...
//     const Expenses = allData.reduce((acc, entry) => {
//       if (entry.amount < 0) {
//         acc += entry.amount;
//       }
//       return acc;
...
//           Current Balance
//         </p>
//         <p className=" font-bold text-[32px] text-white">${(income + expenses).toFixed(2)}</p>
//       </div>
...
//         <p className="text-[#201F24] font-bold text-[32px] ">${Income.toFixed(2)}</p>
//       </div>

//       <div className="flex flex-col gap-3 items-start p-6 rounded-lg bg-white">
//         <p className="text-[14px] font-normal text-[#696868]">Expenses</p>
//         <p className="text-[#201F24] font-bold text-[32px] ">${Math.abs(Expenses).toFixed(2)}</p>
//       </div>
//     </div>
//   );
// };
